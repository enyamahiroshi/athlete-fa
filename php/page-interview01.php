...
get_header(); ?>
      ...
      <div class="mv-interview__main">
        ...
        <div class="mv-interview__main__data">
          ...
          <h1 class="mv-interview__main__catchcopy">
            <span>精密動作を可能とする機構設計</span><br><span>おもしろさと社会への貢献を実感</span>
          </h1>
    ...
    <div class="qa-wrapper">
      ...
      <section class="sec qa qa-interview">
        ...
        <div class="qa__data">
          ...
          <strong class="qa__data__a-title">装置を組み立てる人や、お客様の目線に立って設計ができる技術者になりたいです。</strong>
          <p class="qa__data__a__text">装置が正確に動くということが大前提で、さらに精密な調整ができる機構にすることが求められるので、難しいことに挑戦している感覚があり、そこに面白さを感じています。自分が設計した装置がお客様の工場で使用され、その装置で作られた製品が、普段私たちが何気なく使用しているパソコンやスマートフォンなどの身近な電子機器に使われていると思うと、社会に貢献している気持ちにもなり、この仕事にとてもやりがいを感じます。今後の目標は、まずは設計部での仕事を覚え、装置の担当を任されるようになりたいです。将来的には、実際に装置を組み立てる人や、お客様の目線で設計ができるような技術者になり、何か新しいものを生み出せていけたらと思います。</p>
        </div>
      </section>
    </div>
    ...
    <section class="sec sec-small interview-message">
      ...
      <p class="message-text">大学で学んだことを生かしたいという気持ちがあって設計部希望で入社しましたが、本当に自分にできるのかと不安になることもありました。しかし、ソフトの使い方や製図の書き方など基本的なことから優しく教えてもらい、今も特に悩むことなく仕事に取り組めています。入社を考えている人の中には、技術や知識面を不安に感じている人もいるかと思いますが、相談すると親身になって話を聞いてくれたり、分からないことを教えてくれる優しい先輩ばかりです。初めに配属される製造部での組み立て経験が装置についての知識を深めてくれることもあり、未経験でも問題ありません。<br>自分が会社で一番気に入っているところは、社風や社員間の人間関係です。先輩社員と冗談を言い合えたり、明るく和気あいあいとした雰囲気で、ホッとする瞬間がたくさんありました。<br>最初はできなくても大丈夫です。当社で何かやりたいことがあれば大歓迎します。皆さんと一緒に働けることを楽しみにしています。</p>
