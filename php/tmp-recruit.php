...
<section class="mv-recruit <?php if (is_page('new-graduates')) {
                              echo 'mv-recruit--new-graduates';
                            } elseif (is_page('career')) {
                              echo 'mv-recruit--career';
                            } ?>">
  <?php //キャッチ 
  ?>
  <div class="mv-recruit__recruit-name"><?php if (is_page('new-graduates')) {
                                          echo '新卒採用';
                                        } elseif (is_page('career')) {
                                          echo 'キャリア採用';
                                        } ?></div>
  ...
  <?php endif; ?>
  <h1 class="mv-recruit__catch-copy"><?php if (is_page('new-graduates')) {
                                        echo 'さらにワクワクさせる未来へ';
                                      } elseif (is_page('career')) {
                                        echo '経験を活かし、新たなステージへ';
                                      } ?></h1>
  <?php //ボタン 
  ?>
  <?php if (is_page('new-graduates')): ?>
    <div class="button-wrap">
      ...
      <a href="https://job.mynavi.jp/27/pc/search/corp91106/outline.html" target="_blank" rel="noopener noreferrer" class="button-r-link-large button-circle-ani --white --blank">
...
<section class="sec sec-wide sec-news">
  <div class="layout-block">
    <div class="layout-block__left">
      <h2 class="title02 --data-sub-ja" data-sub="<?php if (is_page('new-graduates')) {
                                                    echo '新卒採用に関する&#10;';
                                                  } elseif (is_page('career')) {
                                                    echo 'キャリア採用に関する&#10;';
                                                  } ?>お知らせ">News</h2>
    ...
    <ul class="post-list">
      ...
      <?php else: ?>
        <li>
          <div class="not-post">まだ記事はありません。</div>
        </li>
      <?php endif;
      wp_reset_postdata(); ?>
    </ul>
...
<section class="sec sec-full sec-future-arts">
  ...
  <div class="future-arts">
    <div class="future-arts__data">
      <h2 class="title06" data-sub="Join our TEAM"><?php if (is_page('new-graduates')) {
                                                      echo '私たちと一緒に働きましょう！';
                                                    } elseif (is_page('career')) {
                                                      echo 'あなたの力を貸してください！';
                                                    } ?></h2>
      <p class="future-arts__data__text"><?php if (is_page('new-graduates')) {
                                            echo '装置の開発から設計、製造に至るまで、ありとあらゆる場面で新しい技術に触れることになります。新たなことへのチャレンジは決して楽な道のりではありませんし、苦悩することもあります。でも大丈夫。行き詰ったときには声をかけてください。必ず先輩社員や周りの仲間たちが力になってくれます。<br>私たちと一緒にFuture Artsの創造をしてみませんか？';
                                          } elseif (is_page('career')) {
                                            echo '技術の進歩、社会的背景に伴い、企業のあり方や人々の働き方は日々変化を続けています。これからの時代を生き抜く持続可能な企業であり続けるために、弊社も一歩ずつ着実に成長を重ねていかなければなりません。社会に対してより存在意義のある会社になるために、従業員にとってより働きやすい会社となるために、多様な人材の価値観を取り入れ、新しい風を吹かせていきたいと考えています。アスリートFAの未来への一歩に、ぜひあなたの力を貸してください。';
                                          } ?></p>
    </div>
    <figure class="future-arts__image">
...
<section id="flow" class="sec sec-medium sec-selection-flow">
  ...
  <div class="selection-flow">
    ...
    <div class="selection-flow__data">
      <h3 class="selection-flow__data__title"><?php if (is_page('new-graduates')) {
                                                echo 'エントリー';
                                              } elseif (is_page('career')) {
                                                echo '応募';
                                              } ?></h3>
      <?php if (is_page('new-graduates')): ?>
        ...
        <a href="https://job.mynavi.jp/27/pc/search/corp91106/outline.html" target="_blank" rel="noopener noreferrer" class="button button--white button--blank"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/recruit/icon-mynavi2027.svg" alt=""></a>
      <?php elseif (is_page('career')): ?>
