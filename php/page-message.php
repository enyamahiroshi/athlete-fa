    ...
    <section class="sec sec-medium">
      <div class="president">
        <div class="president__message">
          ...
          <p>経営理念に「私たち、アスリートFAはFuture Artsを創造します」とあります。Future Artsは社会や私たちの生活を豊かで、より過ごしやすいものとするための、現在から未来への架け橋となる技術を意味しています。<br>アスリートFAはFuture Artsの創造を通して、お客様のビジネスの可能性を拡げるチカラになるとともに、豊かな社会に貢献していきます。</p>
