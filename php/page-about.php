...
<div class="has-column">
  ...
  <section class="main-column">
    ...
    <div id="access" class="cont js-positionNav-target">
      ...
      <div class="access">
        <div class="access__data">
          <div class="access__data__title">東京オフィス</div>
          <p>〒150-0022<br>渋谷区恵比寿南1-1-1<br>ヒューマックス恵比寿ビル7F(726)</p>
          <p></span><a href="https://maps.app.goo.gl/C43KmARZo4qRBwwx7" target="_blank" rel="noopener noreferrer" class="ff-en after-icon after-icon--map">Google Map</a></p>
        </div>
        <figure class="access__image">
        </figure>
      </div>
