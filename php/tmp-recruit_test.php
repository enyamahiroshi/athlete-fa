...
get_header(); ?>
    ...
    <section class="mv-recruit <?php if( is_page('new-graduates') ){ echo 'mv-recruit--new-graduates'; } elseif( is_page('career') ){ echo 'mv-recruit--career'; } ?>">
      ...
      <div class="button-wrap">
        ...
        <a href="https://job.mynavi.jp/26/pc/search/corp91106/outline.html" target="_blank" rel="noopener noreferrer" class="button-r-link-large button-circle-ani --white --blank">
    ...
    <section id="flow" class="sec sec-medium sec-selection-flow">
      ...
      <div class="selection-flow">
        ...
        <div class="selection-flow__data">
          ...
          <a href="https://job.mynavi.jp/26/pc/search/corp91106/outline.html" target="_blank" rel="noopener noreferrer" class="button button--white button--blank"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/recruit/icon-mynavi2026.svg" alt=""></a>
          <?php elseif( is_page('career') ): ?>
